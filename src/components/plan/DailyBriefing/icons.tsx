 ...
 * DailyBriefing Icons
 *
 * Clean SVG icons used throughout the DailyBriefing component.
 * All icons follow a consistent style with no emojis.
 */
...
export function TaskPlusIcon({ className = "" }: IconProps) {
    return (
        <svg
            className={className}
            width="14"
